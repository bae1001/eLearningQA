...
\resizebox{\textwidth}{!}{%
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		\begin{tabular}[c]{@{}l@{}}Los estudiantes\\ pueden ver las\\ condiciones\\ necesarias para\\ completar una\\ actividad\end{tabular} &              &           &             &           &         \\ \hline
		\begin{tabular}[c]{@{}l@{}}Todas las\\ actividades tienen\\ la misma nota\\ máxima en el\\ calificador\end{tabular}                  &              &           &             &           &         \\ \hline
	\end{tabular}%
}
\end{table}
...
\resizebox{\textwidth}{!}{%
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		\begin{tabular}[c]{@{}l@{}}El calificador no\\ tiene demasiado\\ anidamiento\end{tabular}                  &              &           &             &           &         \\ \hline
