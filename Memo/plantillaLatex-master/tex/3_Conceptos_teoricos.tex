...
\begin{itemize}
	...
	\item \textbf{LMS:}
	Los LMS (Learning Management Systems, o sistemas de gestión del aprendizaje) son plataformas online que permiten gestionar el aprendizaje de grupos de personas en un entorno virtual. El aprendizaje en este tipo de plataformas no se limita al académico, sino que también se pueden usar los LMS dentro de empresas para instruir a los empleados. Entre los más populares se encuentran Moodle, Edmodo y Blackboard.
	\item \textbf{Moodle:}
	Moodle es una plataforma de aprendizaje LMS que permite a los profesores crear entornos de aprendizaje altamente personalizables. Fue creado por Martin Dougiamas que publicó su primera versión el 20 de agosto de 2002 \cite{dougiamas2002interpretive} (no estoy asociado a Moodle).
\end{itemize}
...
A partir de las consultas anteriores podemos inferir una serie de buenas prácticas que la aplicación pretende fomentar. También me baso en la experiencia que he tenido como alumno en la plataforma UBUVirtual. Estas cuestiones no llegan a cubrir por completo lo que sería una especie de guía para gestionar cursos virtuales, pero es un comienzo.
