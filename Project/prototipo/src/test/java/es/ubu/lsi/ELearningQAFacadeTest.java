...
class ELearningQAFacadeTest {
    ...
    public static void BeforeClass() {
        ...
        try {
            ...
            for (Long id : ids) {
                ...
                listasModulos.add(Arrays.asList(mapper.readValue(new File(ruta + "Listamodulos" + id + extension),
                        es.ubu.lsi.model.Module[].class)));
                listasGrupos.add(Arrays
                        .asList(mapper.readValue(new File(ruta + "Listagrupos" + id + extension), Group[].class)));
                listasTareas.add(Arrays
                        .asList(mapper.readValue(new File(ruta + "Listatareas" + id + extension), Assignment[].class)));
                listasCalificadores.add(Arrays.asList(
                        mapper.readValue(new File(ruta + "Listacalificadores" + id + extension), Table[].class)));
                listasRecursos.add(Arrays
                        .asList(mapper.readValue(new File(ruta + "Listarecursos" + id + extension), Resource[].class)));
                listasModulosTareas.add(Arrays.asList(mapper
                        .readValue(new File(ruta + "Listamodulostareas" + id + extension), CourseModule[].class)));
                listasUsuarios.add(Arrays
                        .asList(mapper.readValue(new File(ruta + "Listausuarios" + id + extension), User[].class)));
                listasPosts.add(
                        Arrays.asList(mapper.readValue(new File(ruta + "Listaposts" + id + extension), Post[].class)));
                listasTareasConNotas.add(Arrays.asList(
                        mapper.readValue(new File(ruta + "Listatareasconnotas" + id + extension), Assignment[].class)));
                listasAnalisis.add(Arrays.asList(
                        mapper.readValue(new File(ruta + "Listaanalisis" + id + extension), ResponseAnalysis[].class)));
                listasSurveys.add(Arrays
                        .asList(mapper.readValue(new File(ruta + "Listasurveys" + id + extension), Survey[].class)));
            }
        } catch (Exception e) {
    ...
    void isEstanActualizadosRecursosTest() {
        assertTrue(fachada.isEstanActualizadosRecursos(
                WebServiceClient.obtenerRecursosDesfasados(listaCursos.get(0), listasRecursos.get(0)), registro));
        assertTrue(fachada.isEstanActualizadosRecursos(
                WebServiceClient.obtenerRecursosDesfasados(listaCursos.get(4), listasRecursos.get(1)), registro));
        assertTrue(fachada.isEstanActualizadosRecursos(
                WebServiceClient.obtenerRecursosDesfasados(listaCursos.get(3), listasRecursos.get(2)), registro));
        assertTrue(fachada.isEstanActualizadosRecursos(
                WebServiceClient.obtenerRecursosDesfasados(listaCursos.get(8), listasRecursos.get(3)), registro));
        assertTrue(fachada.isEstanActualizadosRecursos(
                WebServiceClient.obtenerRecursosDesfasados(listaCursos.get(9), listasRecursos.get(4)), registro));
        assertTrue(fachada.isEstanActualizadosRecursos(
                WebServiceClient.obtenerRecursosDesfasados(listaCursos.get(2), listasRecursos.get(5)), registro));
    }

    @org.junit.jupiter.api.Test
    void isSonFechasCorrectasTest() {
        assertTrue(fachada.isSonFechasCorrectas(
                WebServiceClient.obtenerModulosMalFechados(listaCursos.get(0), listasModulos.get(0)), registro));
        assertTrue(fachada.isSonFechasCorrectas(
                WebServiceClient.obtenerModulosMalFechados(listaCursos.get(4), listasModulos.get(1)), registro));
        assertTrue(fachada.isSonFechasCorrectas(
                WebServiceClient.obtenerModulosMalFechados(listaCursos.get(3), listasModulos.get(2)), registro));
        assertTrue(fachada.isSonFechasCorrectas(
                WebServiceClient.obtenerModulosMalFechados(listaCursos.get(8), listasModulos.get(3)), registro));
        assertTrue(fachada.isSonFechasCorrectas(
                WebServiceClient.obtenerModulosMalFechados(listaCursos.get(9), listasModulos.get(4)), registro));
        assertFalse(fachada.isSonFechasCorrectas(
                WebServiceClient.obtenerModulosMalFechados(listaCursos.get(2), listasModulos.get(5)), registro));
    }
    ...
    void generarCampoRelativoTest() {
        ...
        assertEquals(fachada.generarCampoRelativo(-0.1f, 100),
                "<td class=\"tg-pred\"><meter value=\"-0.1\" min=\"0\" max=\"100.0\"></meter>-0" + sep + "1%</td>");
        assertEquals(fachada.generarCampoRelativo(0, 100),
                "<td class=\"tg-pred\"><meter value=\"0.0\" min=\"0\" max=\"100.0\"></meter>0" + sep + "0%</td>");
        assertEquals(fachada.generarCampoRelativo(19.9f, 100),
                "<td class=\"tg-pred\"><meter value=\"19.9\" min=\"0\" max=\"100.0\"></meter>19" + sep + "9%</td>");
        assertEquals(fachada.generarCampoRelativo(20, 100),
                "<td class=\"tg-oran\"><meter value=\"20.0\" min=\"0\" max=\"100.0\"></meter>20" + sep + "0%</td>");
        assertEquals(fachada.generarCampoRelativo(39.9f, 100),
                "<td class=\"tg-oran\"><meter value=\"39.9\" min=\"0\" max=\"100.0\"></meter>39" + sep + "9%</td>");
        assertEquals(fachada.generarCampoRelativo(40.0f, 100),
                "<td class=\"tg-yell\"><meter value=\"40.0\" min=\"0\" max=\"100.0\"></meter>40" + sep + "0%</td>");
        assertEquals(fachada.generarCampoRelativo(59.9f, 100),
                "<td class=\"tg-yell\"><meter value=\"59.9\" min=\"0\" max=\"100.0\"></meter>59" + sep + "9%</td>");
        assertEquals(fachada.generarCampoRelativo(60, 100),
                "<td class=\"tg-char\"><meter value=\"60.0\" min=\"0\" max=\"100.0\"></meter>60" + sep + "0%</td>");
        assertEquals(fachada.generarCampoRelativo(79.9f, 100),
                "<td class=\"tg-char\"><meter value=\"79.9\" min=\"0\" max=\"100.0\"></meter>79" + sep + "9%</td>");
        assertEquals(fachada.generarCampoRelativo(80, 100),
                "<td class=\"tg-pgre\"><meter value=\"80.0\" min=\"0\" max=\"100.0\"></meter>80" + sep + "0%</td>");
        assertEquals(fachada.generarCampoRelativo(100, 100),
                "<td class=\"tg-pgre\"><meter value=\"100.0\" min=\"0\" max=\"100.0\"></meter>100" + sep + "0%</td>");
        assertEquals(fachada.generarCampoRelativo(100.1f, 100),
                "<td class=\"tg-pgre\"><meter value=\"100.1\" min=\"0\" max=\"100.0\"></meter>100" + sep + "1%</td>");
    }
}